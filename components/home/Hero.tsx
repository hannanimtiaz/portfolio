...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">HI there, I'm Hannan.</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          I love to <span className="heroShiny1 text-fun-pink">create</span> and{" "}
          <span className="heroShiny2 text-fun-pink">learn</span> new things for
          the web.
          <img
            alt="html"
